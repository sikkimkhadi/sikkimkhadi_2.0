...
@Component({
  selector: 'app-mendogaon',
  standalone: true,
  imports: [CommonModule, RouterModule, TitleCasePipe],
  templateUrl: './mendogaon.component.html',
  styleUrl: './mendogaon.component.css'
})
export class MendogaonComponent implements OnInit, OnDestroy {
  centerDetail$!: Observable<ProductionCenterDetail | null>;
  loading = true;
  showBackButton = false;
  private destroy$ = new Subject<void>();
  private centerId = 'mendogaon';
