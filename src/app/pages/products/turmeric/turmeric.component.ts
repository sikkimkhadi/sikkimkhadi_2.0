...
@Component({
  ...
  templateUrl: './turmeric.component.html',
  styleUrl: './turmeric.component.css'
})
export class TurmericComponent implements OnInit, OnDestroy {
  ...
  private loadProductData(): void {
    this.loading = true;
    this.product$ = this.productsService.getProductById('turmeric');
